...
<head>
    ...
    <style>
        ...
        .name-container, .beschreibung-container, .kenntnisse-container, .interesse-container, .status-container {
            line-height: 1.2em;
            max-height: 8em;
            overflow-y: auto;
            word-wrap: break-word;
            ...
            <div class="card filter-card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('welcome') }}">
                        ...
                        <input type="text" name="betreuer" class="form-control" placeholder="Betreuer" value="{{ request('betreuer') }}">
                        <input type="text" name="kenntnisse" class="form-control" placeholder="Kenntnisse" value="{{ request('kenntnisse') }}">
                        <select name="status" class="form-select">
                            ...
                            @else
                                <option value="Angebot" {{ request('status') === 'Angebot' ? 'selected' : '' }}>Angebot</option>
                                <option value="Aktiv" {{ request('status') === 'Aktiv' ? 'selected' : '' }}>Aktiv</option>
                                <option value="Fertig" {{ request('status') === 'Fertig' ? 'selected' : '' }}>Fertig</option>
                        ...
                        <div class="filter-buttons">
                            ...
                            <button type="button" onclick="resetPage()" class="button-24">Reset</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="right-column">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span>Alle öffentliche Thesen</span>
                </div>
                                    ...
                                    <td>
                                        <div class="interesse-container">
                                            @if(auth()->check())
                                                ...
                                                @endif
                                            @else
                                                <span class="badge bg-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Es gibt {{ $thesis->interesse }} Studenten, die ebenfalls an diesem Projekt interessiert sind. Bitte registrieren Sie sich, um ihre Kontaktinformationen zu erhalten;">
                                                    {{ $thesis->interesse }}
                                                </span>
                                            @endif
                                        </div>
