        ...
        <div class="right-column">
            <div class="card">
                <div class="card-header text-center">
                    <span class="w-100">Passwort zurücksetzen</span>
                </div>
                ...
                <div class="form-container">
                    <form method="POST" action="{{ route('password.verify.submit') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('reset_code') is-invalid @enderror" id="reset_code" name="reset_code" value="{{ old('reset_code') }}" required>
                            <small class="text-muted">Geben Sie den 7-stelligen Code ein, den Sie per E-Mail erhalten haben.</small>
                            @error('reset_code')
                                <div class="error">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Mindestens 8 Zeichen, Groß- und Kleinbuchstaben, Sonderzeichen.</small>
                            @error('password')
                                <div class="error">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        @if(config('app.recaptcha.enabled') && Session::get('verify_reset_attempts_' . old('email', '')) >= 5)
                            <div class="mb-3">
                        ...
                        <button type="submit" class="button-24">Passwort zurücksetzen</button>
                    </form>

                    <div class="text-center mt-3">
                        <p>Code nicht erhalten? <a href="{{ route('password.resend') }}">Code erneut senden</a></p>
                    </div>
                </div>
            </div>
        </div>
