...
<head>
    ...
    <title>Reset-Code erneut senden</title>
    ...
    <style>
        ...
        .button-24:active { background-color: initial; color: #003366; }
        ...
        <div class="right-column">
            <div class="card">
                <div class="card-header text-center">
                    <span class="w-100">Reset-Code erneut senden</span>
                </div>
                ...
                <div class="form-container">
                    <form method="POST" action="{{ route('password.resend.submit') }}">
                        @csrf
                        <div class="mb-3">
                        ...
                        @if(config('app.recaptcha.enabled') && Session::get('resend_attempts_' . old('email', '')) >= 5)
                            <div class="mb-3">
