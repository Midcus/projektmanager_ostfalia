    ...
    <div class="right-column">
        <div class="card">
            <div class="card-header">
                <span class="w-100">Thesis Erstellen</span>
            </div>
            ...
            <div class="form-container">
                <form action="{{ route('thesis.store') }}" method="POST" enctype="multipart/form-data" id="thesisForm">
                    @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('notiz') is-invalid @enderror" id="notiz" name="notiz" rows="5">{{ old('notiz') }}</textarea>
                        ...
                        <div class="card-body">
                            <div class="mb-3" id="projektartContainer">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input projektart-checkbox" name="projektart[]" value="Teamprojekt" id="teamprojekt" {{ in_array('Teamprojekt', old('projektart', [])) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="teamprojekt">Teamprojekt</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input projektart-checkbox" name="projektart[]" value="Studienarbeit" id="studienarbeit" {{ in_array('Studienarbeit', old('projektart', [])) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="studienarbeit">Studienarbeit</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input projektart-checkbox" name="projektart[]" value="Bachelorthesis" id="bachelorthesis" {{ in_array('Bachelorthesis', old('projektart', [])) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="bachelorthesis">Bachelorthesis</label>
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input projektart-checkbox" name="projektart[]" value="Masterthesis" id="masterthesis" {{ in_array('Masterthesis', old('projektart', [])) ? 'checked' : '' }}>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" name="geheim" id="geheim_yes" value="yes" {{ old('geheim') === 'yes' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="geheim_yes">Ja</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" name="geheim" id="geheim_no" value="no" {{ old('geheim') === 'no' ? 'checked' : '' }} checked>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('kenntnisse') is-invalid @enderror" id="kenntnisse" name="kenntnisse" value="{{ old('kenntnisse') }}" required>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('semester_type') is-invalid @enderror small-input" id="semester_type" name="semester_type">
                                    <option value="N/A" {{ old('semester_type', 'N/A') == 'N/A' ? 'selected' : '' }}>N/A</option>
                                    <option value="WS" {{ old('semester_type') == 'WS' ? 'selected' : '' }}>WS (Wintersemester)</option>
                                    <option value="SS" {{ old('semester_type') == 'SS' ? 'selected' : '' }}>SS (Sommersemester)</option>
                                </select>
                            ...
                            <div class="mb-3" id="semesterYearGroup" style="display: none;">
                                ...
                                <input type="text" class="form-control @error('semester_year') is-invalid @enderror small-input" id="semester_year" name="semester_year" pattern="\d{4}" placeholder="z.B. 2025" value="{{ old('semester_year') }}">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror small-input" id="status" name="status" required>
                                    <option value="Angebot" {{ old('status') == 'Angebot' ? 'selected' : '' }}>Angebot</option>
                                    <option value="Aktiv" {{ old('status') == 'Aktiv' ? 'selected' : '' }}>Aktiv</option>
                                    <option value="Fertig" {{ old('status') == 'Fertig' ? 'selected' : '' }}>Fertig</option>
                            ...
                            <div class="mb-3 hidden" id="startdatumGroup">
                                ...
                                <input type="date" class="form-control @error('startdatum') is-invalid @enderror small-input" id="startdatum" name="startdatum" value="{{ old('startdatum') }}">
                                @error('startdatum')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

                            <div class="mb-3 hidden" id="enddatumGroup">
                                <label for="enddatum" class="form-label attribute-card-header">
                                    <strong>Enddatum</strong> <small class="optional-text">(optional)</small>
                                </label>
                                <input type="date" class="form-control @error('enddatum') is-invalid @enderror small-input" id="enddatum" name="enddatum" value="{{ old('enddatum') }}">
                                @error('enddatum')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>

                            <div class="mb-3 hidden" id="vortragdatumGroup">
                                ...
                                <input type="date" class="form-control @error('vortragdatum') is-invalid @enderror small-input" id="vortragdatum" name="vortragdatum" value="{{ old('vortragdatum') }}">
                                @error('vortragdatum')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control @error('pdf_1') is-invalid @enderror" id="pdf_1" name="pdf_1" accept=".pdf">
                                @error('pdf_1')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control @error('pdf_2') is-invalid @enderror" id="pdf_2" name="pdf_2" accept=".pdf">
                                @error('pdf_2')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <!-- Nút submit -->
                    <button type="submit" class="button-24">Thesis erstellen</button>
                </form>
            </div>
        </div>
    </div>
